...
CATALOG_SEED = [
    # —— Attivabili ora (feed_pull su XML OMNIA) ——
    {"slug": "subito", "name": "Subito.it", "category": "freemium", "dialect": "osf_federata",
     ...
     "notes": "Traffico generalista alto. Attiva e comunica l'URL feed OMNIA al portale."},
    {"slug": "wikicasa", "name": "Wikicasa.it", "category": "freemium", "dialect": "generic_rss",
     ...
     "notes": "Free tier fino a ~20 annunci; oltre serve piano a pagamento sul portale."},
    {"slug": "bakeca", "name": "Bakeca.it", "category": "gratuito", "dialect": "osf_federata",
     ...
     "notes": "Gratuito con pubblicita'. Setup semplice via feed."},
    {"slug": "trovocasa", "name": "Trovocasa.it", "category": "freemium", "dialect": "osf_federata",
     "integration_type": "feed_pull", "traffic_score": 3, "integration_ready": True,
     "credential_fields": [{"name": "email", "label": "Email account", "type": "email"}],
     "notes": "Portale generalista. Attiva e registra l'URL feed OMNIA sul loro pannello."},
    {"slug": "kijiji", "name": "Kijiji.it", "category": "gratuito", "dialect": "osf_federata",
     ...
     "credential_fields": [{"name": "email", "label": "Email account", "type": "email"}],
     "notes": "Adevinta group. Feed pull."},
    {"slug": "attico", "name": "Attico.it", "category": "freemium", "dialect": "osf_federata",
     "integration_type": "feed_pull", "traffic_score": 2, "integration_ready": True,
     "credential_fields": [{"name": "email", "label": "Email account", "type": "email"}],
     "notes": "Free tier limitato."},
    {"slug": "case24", "name": "Case24.it", "category": "freemium", "dialect": "osf_federata",
     "integration_type": "feed_pull", "traffic_score": 2, "integration_ready": True,
     "credential_fields": [{"name": "email", "label": "Email account", "type": "email"}],
     "notes": "Portale generalista minore."},
    # —— In catalogo, non ancora attivi (niente sync finto) ——
    {"slug": "immobiliare", "name": "Immobiliare.it", "category": "a_pagamento", "dialect": "osf_federata",
     "integration_type": "feed_pull", "traffic_score": 5, "integration_ready": False,
     "credential_fields": [{"name": "agency_code", "label": "Codice agenzia", "type": "text"},
                           {"name": "api_key", "label": "API Key / token", "type": "text"}],
     "notes": "Non ancora attivo: serve accordo/integrazione ufficiale. Continua sul loro pannello agenzia."},
    {"slug": "idealista", "name": "Idealista.it", "category": "a_pagamento", "dialect": "osf_federata",
     "integration_type": "feed_pull", "traffic_score": 5, "integration_ready": False,
     "credential_fields": [{"name": "agency_code", "label": "Codice agenzia", "type": "text"},
                           {"name": "api_key", "label": "API Key / token", "type": "text"}],
     "notes": "Non ancora attivo: serve accordo/integrazione ufficiale (spesso PULL dal sito)."},
    {"slug": "casa", "name": "Casa.it", "category": "a_pagamento", "dialect": "osf_federata",
     "integration_type": "feed_pull", "traffic_score": 4, "integration_ready": False,
     "credential_fields": [{"name": "agency_code", "label": "Codice agenzia", "type": "text"},
                           {"name": "api_key", "label": "API Key / token", "type": "text"}],
     "notes": "Non ancora attivo: serve accordo/integrazione ufficiale."},
    ...
    {"slug": "gate-away", "name": "Gate-away", "category": "a_pagamento", "dialect": "generic_rss",
     "integration_type": "feed_pull", "traffic_score": 3, "integration_ready": False,
     "credential_fields": [{"name": "api_key", "label": "API Key", "type": "text"}],
     "notes": "Non ancora attivo: verticale lusso/estero — integrazione non ancora collegata."},
    {"slug": "mitula", "name": "Mitula", "category": "aggregatore", "dialect": "generic_rss",
     "integration_type": "feed_pull", "traffic_score": 2, "integration_ready": False,
     "credential_fields": [{"name": "email", "label": "Email account", "type": "email"}],
     "notes": "Non ancora attivo: aggregatore — tubo OMNIA non ancora verificato."},
    {"slug": "trovit", "name": "Trovit", "category": "aggregatore", "dialect": "generic_rss",
     "integration_type": "feed_pull", "traffic_score": 2, "integration_ready": False,
     "credential_fields": [{"name": "email", "label": "Email account", "type": "email"}],
     "notes": "Non ancora attivo: aggregatore — tubo OMNIA non ancora verificato."},
]
