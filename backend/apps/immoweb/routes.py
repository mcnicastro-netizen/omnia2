...
from apps.immoweb.modulistica import router as modulistica_router
from apps.immoweb.activities import router as activities_router
...
router.include_router(modulistica_router)
