...
SUBJECTS = {
    ...
    "request_match_alert": {
        "it": "🔔 {{match_count}} immobili per la tua richiesta «{{request_title}}»",
        "en": "🔔 {{match_count}} properties for your request “{{request_title}}”",
        "es": "🔔 {{match_count}} inmuebles para tu solicitud «{{request_title}}»",
    },
    "error_alert": {
