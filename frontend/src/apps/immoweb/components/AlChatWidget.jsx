      ...
      if (!resp.ok) {
        ...
        const msg =
          detail === "rate_limit_exceeded" ? t("al.err_rate_limit")
            : (detail === "llm_budget_exceeded" || detail === "llm_unavailable" || detail === "llm_busy") ? t("al.err_unavailable")
            : t("al.err_generic");
      ...
      while (true) {
        ...
        for (const frame of frames) {
          ...
          switch (evt.type) {
            ...
            case "error": {
              const m =
                evt.detail === "llm_budget_exceeded" || evt.detail === "llm_unavailable" || evt.detail === "llm_busy"
