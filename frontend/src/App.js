...
const ImportHubPage = lazy(() => import("@/apps/immoweb/pages/ImportHubPage"));
            ...
            element={
              <LangSync>
                <Routes>
                  ...
                  />
                  <Route
                    path="app/modulistica"
                    element={
                      <ProtectedRoute allowedRoles={["super_admin", "agency_admin", "agent", "group_admin", "branch_admin"]}>
                        <ModulisticaPage />
                      </ProtectedRoute>
                    }
                  />
