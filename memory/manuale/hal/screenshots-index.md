...
| 5 | `cap1-sidebar-completa` | Barra a sinistra completa con tutte le voci visibili al ruolo **titolare** (Dashboard, Gruppo, Importa, Portali, Immobili, Clienti, Richieste, Match, … Impostazioni). **API Keys non in sidebar** (D-092: sotto Impostazioni). | 🔴 | Login come utente demo *agency_admin* attivo su agenzia demo. | — |
...
| # | ID | Cosa mostrare | Priorità | Note | Fatto |
|---|----|---------------|:-:|------|:-:|
| 1 | `cap6-portali-panoramica` | Pagina **Portali** con hero + 3 metric (Attivi / Attivabili ora / In arrivo) + banner onestà + **3 tab** Attivi oggi / Attivabili ora / In arrivo (D-092). | 🔴 | Agenzia demo *Immobiliare Rossi* con 2 portali attivi (Subito + Bakeca). | — |
